...
const yeniTatlar = "Kakule";
const yeniDizi = cesitEkle(orijinalTatlar, yeniTatlar);
...
const guncellenmisDizi = sonCesitiKaldir(orijinalTatlar);

console.log(guncellenmisDizi);
...
const indeks = 2;
const seciliCesit = indekstekiCesitiGetir(orijinalTatlar, indeks);

console.log(seciliCesit);
...
function ismeGoreCesitCikar(tatlar, lezzet) {
  const indeks = tatlar.indexOf(lezzet);
...
const lezzet = "Tarçın";
const guncelDizi = ismeGoreCesitCikar(orijinalTatlar, lezzet);

console.log(guncelDizi);
...
const filtrelenmisDizi = ismeGoreFiltrele(orijinalTatlar, filtre);
